...
func (v *Widget) SetColormap(colormap *gdk.Colormap) {
	C._gtk_widget_set_colormap(v.GWidget, C.toGdkColormap(unsafe.Pointer(colormap.GColormap)))
}
...
func (v *Widget) GetRootWindow() *Window {
	return &Window{Bin{Container{Widget{
		C.toGWidget(unsafe.Pointer(C.gtk_widget_get_root_window(v.GWidget)))}}}}
}

// gtk_widget_get_screen

func (v *Widget) GetScreen() *gdk.Screen {
	ptr := unsafe.Pointer(C.gtk_widget_get_screen(v.GWidget))
	return gdk.ScreenFromUnsafe(ptr)
}
